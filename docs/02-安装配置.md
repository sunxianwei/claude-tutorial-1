...
> 本章假设你已安装 Claude Code。如未安装，请先参考 [第 01 章快速开始](01-快速开始.md)中的安装部分。
...
- 📖 **学习规范** → [第 06 章：规则文件系统](06-规则文件系统.md)
- 🔧 **扩展工具** → [第 03 章：MCP 配置指南](03-MCP配置指南.md)
- 💻 **开始编码** → [第 11 章：新项目工作流](11-新项目工作流.md)
- 🚀 **快速上手** → [第 01 章：快速开始](01-快速开始.md)
