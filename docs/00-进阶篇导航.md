...
#### 2. [Skills 完全指南](13-Skills指南.md) ⭐ 新增
**时间：** 20 分钟 | **难度：** ⭐⭐ | **优先级：** 🔴 重要
...
#### 14. [IDE 集成](10-IDE集成.md)
**时间：** 10 分钟 | **难度：** ⭐⭐

#### 15. [历史会话管理](11-会话管理.md)
**时间：** 10 分钟 | **难度：** ⭐⭐

#### 16. [可视化工具](20-可视化工具.md)
**时间：** 15 分钟 | **难度：** ⭐⭐
...
**Day 4-7：Skills 系统**
1. 阅读 [Skills 完全指南](13-Skills指南.md)（20 分钟）
...
**Day 1-3：SubAgents**
1. 阅读 [SubAgents 使用](12-子代理使用.md)（15 分钟）
2. 配置自定义 SubAgent（30 分钟）
3. 实践链式 Agent 工作流（45 分钟）

**Day 4-5：切换模型**
1. 阅读 [切换模型供应商](16-模型切换.md)（15 分钟）
