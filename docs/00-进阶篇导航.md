...
#### 2. [Skills 完全指南](20-Skills指南.md) ⭐ 新增
**时间：** 20 分钟 | **难度：** ⭐⭐ | **优先级：** 🔴 重要
...
#### 14. [IDE 集成](14-IDE集成.md)
**时间：** 10 分钟 | **难度：** ⭐⭐

#### 15. [历史会话管理](15-会话管理.md)
**时间：** 10 分钟 | **难度：** ⭐⭐

#### 16. [可视化工具](16-可视化工具.md)
**时间：** 15 分钟 | **难度：** ⭐⭐
...
**Day 1-3：MCP 基础**
1. 阅读 [MCP 配置指南](02-MCP配置指南.md)（20 分钟）
2. 配置 3-5 个 MCP 服务器（30 分钟）
3. 测试 MCP 功能（20 分钟）

**Day 4-7：Skills 系统**
1. 阅读 [Skills 完全指南](20-Skills指南.md)（20 分钟）
...
**Day 1-3：SubAgents**
1. 阅读 [SubAgents 使用](03-子代理使用.md)（15 分钟）
2. 配置自定义 SubAgent（30 分钟）
3. 实践链式 Agent 工作流（45 分钟）

**Day 4-5：切换模型**
1. 阅读 [切换模型供应商](21-模型切换.md)（15 分钟）
2. 配置 2-3 个模型供应商（30 分钟）
3. 测试不同模型的效果（30 分钟）

**Day 6-7：命令精通**
1. 阅读 [命令参考](11-命令参考.md)（15 分钟）
2. 练习新增命令（30 分钟）
3. 创建自动化脚本（45 分钟）
...
**专项学习：**
- 阅读 [最佳实践](10-最佳实践.md)
- 阅读 [上下文压缩](05-上下文压缩.md)
- 根据岗位阅读 [使用场景](19-按岗位场景.md)
...
- 🔍 **命令速查**：[命令参考](11-命令参考.md)
- 💬 **社区讨论**：GitHub Discussions

---

**开始学习：** 👉 [MCP 配置指南](02-MCP配置指南.md)
