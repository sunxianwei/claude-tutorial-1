...
| **Skills 系统** | 教会 Claude 新能力 | [20-Skills指南.md](docs/20-Skills指南.md) |
| **模型切换** | 灵活选择 AI 模型 | [21-模型切换.md](docs/21-模型切换.md) |
| **MCP 命令行** | 简化 MCP 管理 | [02-MCP配置指南.md](docs/02-MCP配置指南.md) |
...
3. 🆕 [新项目工作流](docs/08-新项目工作流.md)（20 分钟）
4. 📋 [规则文件系统](docs/04-规则文件系统.md)（20 分钟）
...
3. ⭐ [Skills 完全指南](docs/20-Skills指南.md)（20 分钟）
4. 🔧 [MCP 配置指南](docs/02-MCP配置指南.md)（20 分钟）
5. 🤖 [SubAgents 使用](docs/03-子代理使用.md)（15 分钟）
...
**推荐步骤：**
1. 🚀 [最佳实践](docs/10-最佳实践.md)
2. ⭐ [Skills 完全指南](docs/20-Skills指南.md)
...
- 🔍 [命令参考](docs/11-命令参考.md)
- 💬 [最佳实践](docs/10-最佳实践.md)
