...
| **Skills 系统** | 教会 Claude 新能力 | [13-Skills指南.md](docs/13-Skills指南.md) |
| **模型切换** | 灵活选择 AI 模型 | [16-模型切换.md](docs/16-模型切换.md) |
| **MCP 命令行** | 简化 MCP 管理 | [07-MCP配置指南.md](docs/07-MCP配置指南.md) |
...
3. 🆕 [新项目工作流](docs/05-新项目工作流.md)（20 分钟）
4. 📋 [规则文件系统](docs/02-规则文件系统.md)（20 分钟）
...
3. ⭐ [Skills 完全指南](docs/13-Skills指南.md)（20 分钟）
4. 🔧 [MCP 配置指南](docs/07-MCP配置指南.md)（20 分钟）
5. 🤖 [SubAgents 使用](docs/12-子代理使用.md)（15 分钟）
...
**推荐步骤：**
1. 🚀 [最佳实践](docs/08-最佳实践.md)
2. ⭐ [Skills 完全指南](docs/13-Skills指南.md)
3. 🏢 [老项目开发指南](docs/17-老项目开发指南.md)
...
| 项目 | 版本 | 更新日期 |
|------|------|---------|
| **教程版本** | v2.2 | 2026-01-27 |
| **适配版本** | Claude Code 2.1+ | - |
| **文档数量** | 23 个文档（20个章节+3个导航） | - |
...
- 🔍 [命令参考](docs/06-命令参考.md)
- 💬 [最佳实践](docs/08-最佳实践.md)
